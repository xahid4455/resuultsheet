...
if(isset($_POST['ok'])){
	...
	//if($_POST['unam']==)
 	...
 	if(in_array($_POST['unam'], $usr)){
 	 ...
 	 echo $url='<a href="http://localhost/php/16-01-2020/Student_result/get_code.php?code='.$rand.'">http://localhost/php/16-01-2020/Students_result/get_code.php?code='.$rand.'</a>';
